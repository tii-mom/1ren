          ...
          >
            ...
            >
              ...
              <button
                ...
                className="absolute top-2 right-2 p-3 text-slate-500 hover:text-slate-300 rounded-full hover:bg-white/5 active:scale-95 transition-all flex items-center justify-center cursor-pointer min-w-[44px] min-h-[44px] touch-manipulation z-10"
              >
                <X className="size-5" />
              </button>
